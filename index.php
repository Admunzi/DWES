        ...
        $unidad2 = array(
            ...
            "ejercicios" => array(
                array(
                    ...
                    "url" => "act1/index.php",
                    "github" => "https://github.com/Admunzi/DWES/blob/main/unidad2/tanda1/act1/index.php",
                ),
                array(
                    "nombre" => "Actividad 2",
                    "descripcion" => "Ficha personal con los datos cargados en variables",
                    "url" => "act2/index.php",
                    "github" => "https://github.com/Admunzi/DWES/blob/main/unidad2/tanda1/act2/index.php",
                ),
                array(
                    "nombre" => "Actividad 3",
                    ...
                    "url" => "act3/index.php",
                    "github" => "https://github.com/Admunzi/DWES/blob/main/unidad2/tanda1/act3/index.php",
                ),
                array(
                    "nombre" => "Actividad 4",
                    ...
                    "url" => "act4/index.php",
                    "github" => "https://github.com/Admunzi/DWES/blob/main/unidad2/tanda1/act4/index.php",
                ),
                array(
                    "nombre" => "Actividad 5",
                    "descripcion" => "Script que escriba el resultado de la suma de dos números almacenados en dos variables.",
                    "url" => "act5/index.php",
                    "github" => "https://github.com/Admunzi/DWES/blob/main/unidad2/tanda1/act5/index.php",
                ),
                array(
                    "nombre" => "Actividad 6",
                    "descripcion" => "Script que cargue x variables",
                    "url" => "act6/index.php",
                    "github" => "https://github.com/Admunzi/DWES/blob/main/unidad2/tanda1/act6/index.php",
                ),
                array(
                    "nombre" => "Actividad 7",
                    "descripcion" => "Escribir un script que declare una variable y muestre x información en pantalla:",
                    "url" => "act7/index.php",
                    "github" => "https://github.com/Admunzi/DWES/blob/main/unidad2/tanda1/act7/index.php",
                ),
                array(
                    "nombre" => "Actividad 8",
                    ...
                    "github" => "https://github.com/Admunzi/DWES/blob/main/unidad2/tanda1/act8/index.php",
                    "url" => "act8/index.php"
                ),
                array(
                    "nombre" => "Actividad 9",
                    ...
                    "url" => "act9/index.php",
                    "github" => "https://github.com/Admunzi/DWES/blob/main/unidad2/tanda1/act9/index.php",
                ),
                array(
                    "nombre" => "Actividad 10",
                    "descripcion" => "Pon ejemplo de uso de la sintaxis heredoc en el manejo de cadenas.",
                    "url" => "act10/index.php",
                    "github" => "https://github.com/Admunzi/DWES/blob/main/unidad2/tanda1/act10/index.php",
                ),
            )
        ),
        $unidad3_tanda1 = array(
            ...
            "ejercicios" => array(
                array(
                    ...
                    "url" => "act1/index.php",
                    "github" => "https://github.com/Admunzi/DWES/blob/main/unidad3/tanda1_condicionales/act1/index.php",
                ),
                array(
                    "nombre" => "Actividad 2",
                    "descripcion" => "Carga en variables mes y año e indica el número de días del mes. Utiliza la estructura de control switch",
                    "url" => "act2/index.php",
                    "github" => "https://github.com/Admunzi/DWES/blob/main/unidad3/tanda1_condicionales/act2/index.php",
                ),
                array(
                    "nombre" => "Actividad 3",
                    "descripcion" => "Carga fecha de nacimiento en variables y calcula la edad.",
                    "url" => "act3/index.php",
                    "github" => "https://github.com/Admunzi/DWES/blob/main/unidad3/tanda1_condicionales/act3/index.php",
                ),
                array(
                    "nombre" => "Actividad 4",
                    ...
                    "url" => "act4/index.php",
                    "github" => "https://github.com/Admunzi/DWES/blob/main/unidad3/tanda1_condicionales/act4/index.php",
                ),
                array(
                    "nombre" => "Actividad 5",
                    ...
                    "url" => "act5/index.php",
                    "github" => "https://github.com/Admunzi/DWES/blob/main/unidad3/tanda1_condicionales/act5/index.php",
                )
            )
        ),
        $unidad3_tanda2 = array(
            ...
            "ejercicios" => array(
                array(
                    ...
                    "url" => "act1/index.php",
                    "github" => "https://github.com/Admunzi/DWES/blob/main/unidad3/tanda2_bucles/act1/index.php",
                ),
                array(
                    "nombre" => "Actividad 2",
                    "descripcion" => "Sumar los 3 primeros numeros pares",
                    "url" => "act2/index.php",
                    "github" => "https://github.com/Admunzi/DWES/blob/main/unidad3/tanda2_bucles/act2/index.php",
                ),
                array(
                    "nombre" => "Actividad 3",
                    "descripcion" => "Tablas de multiplicar del 1 al 10.",
                    "url" => "act3/index.php",
                    "github" => "https://github.com/Admunzi/DWES/blob/main/unidad3/tanda2_bucles/act3/index.php",
                ),
                array(
                    "nombre" => "Actividad 4",
                    ...
                    "url" => "act4/index.php",
                    "github" => "https://github.com/Admunzi/DWES/blob/main/unidad3/tanda2_bucles/act4/index.php",
                ),
                array(
                    "nombre" => "Actividad 5",
                    ...
                    "url" => "act5/index.php",
                    "github" => "https://github.com/Admunzi/DWES/blob/main/unidad3/tanda2_bucles/act5/index.php",
                )
            )
        ),
        $unidad3_tanda3 = array(
            ...
            "ejercicios" => array(
                array(
                    ...
                    "url" => "act1/index.php",
                    "github" => "https://github.com/Admunzi/DWES/blob/main/unidad3/tanda3_arrays/act1/index.php",
                ),
                array(
                    "nombre" => "Actividad 2",
                    ...
                    "url" => "act2/index.php",
                    "github" => "https://github.com/Admunzi/DWES/blob/main/unidad3/tanda3_arrays/act2/index.php",
                ),
                array(
                    "nombre" => "Actividad 3",
                    "descripcion" => "
                    ...
                    ",
                    "url" => "act3/index.php",
                    "github" => "https://github.com/Admunzi/DWES/blob/main/unidad3/tanda3_arrays/act3/index.php",
                ),
                array(
                    "nombre" => "Actividad 4",
                    ...
                    "url" => "act4/index.php",
                    "github" => "https://github.com/Admunzi/DWES/blob/main/unidad3/tanda3_arrays/act4/index.php",
                ),
                array(
                    "nombre" => "Actividad 5",
                    "descripcion" => "Mejora calendario con un array de los días festivos: colores diferentes, nacionales, comunidad, locales.",
                    "url" => "act5/index.php",
                    "github" => "https://github.com/Admunzi/DWES/blob/main/unidad3/tanda3_arrays/act5/index.php",
                )
            )
        ),
        $unidad3_6a10= array(
            ...
            "ejercicios" => array(
                array(
                    ...
                    "url" => "act1/index.php",
                    "github" => "https://github.com/Admunzi/DWES/blob/main/unidad3/ejercicios_6-10/act1/index.php",
                ),
                array(
                    "nombre" => "Actividad 2",
                    ...
                    "url" => "act2/index.php",
                    "github" => "https://github.com/Admunzi/DWES/blob/main/unidad3/ejercicios_6-10/act2/index.php",
                ),
                array(
                    "nombre" => "Actividad 3",
                    ...
                    "url" => "act3/index.php",
                    "github" => "https://github.com/Admunzi/DWES/blob/main/unidad3/ejercicios_6-10/act3/index.php",
                ),
                array(
                    "nombre" => "Actividad 4",
                    ...
                    *       igual que en el ejemplo.",
                    "url" => "act4/index.php",
                    "github" => "https://github.com/Admunzi/DWES/blob/main/unidad3/ejercicios_6-10/act4/index.php",
                ),
            )
        ),
        $unidad3_formularios= array(
            "descripcion" => "Unidad 3 Formularios",
            "carpeta" => "unidad3/tanda4_formularios/",
            "ejercicios" => array(
                array(
                    "nombre" => "Actividad 1",
                    "descripcion" => "Modifica el ejercicio del calendario para que el mes y el año se lean en un formulario. Añade las
        ...
        foreach ($info[$i] as $key => $arrayUnidad) {
            ...
            if ($key == "ejercicios") {
                foreach ($arrayUnidad as $key => $arrayEjercicios) {
                    ...
                    echo("<a href=\" ". $arrayEjercicios["github"] ." \" class=\"btn green\">Ir a github</a>");
                    echo("</div>");//<!--/card-->
                }
            }
        }
